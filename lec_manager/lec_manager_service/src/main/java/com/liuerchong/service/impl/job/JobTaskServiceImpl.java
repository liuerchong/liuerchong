...
import com.liuerchong.job.mapper.ScheduleJobMapper;
...
public class JobTaskServiceImpl implements JobTaskService{
	...
	public final Logger log = Logger.getLogger(this.getClass());
	   ...
	   public List<ScheduleJob> getAllTask() {
		   ...
		   ScheduleJobExample s = new ScheduleJobExample();
	      return scheduleJobMapper.selectByExample(s);
	   }
	   ...
	   public void init() throws Exception {
	      ...
	      // 这里获取任务信息数据
	      List<ScheduleJob> jobList = scheduleJobMapper.selectByExample(scheduleJobExample);
