...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <div class="layui-logo">ERP 1.0</div>
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-shrink="all" lay-filter="">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" path="empList" tab-id="1-1">用户列表</a></dd>
<%--                         <dd><a href="javascript:;" path="${pageContext.request.contextPath}/user/toList" tab-id="1-1">用户列表</a></dd> --%>
                        <dd><a href="javascript:;" path="article.html" tab-id="1-2">文章列表</a></dd>
                        <dd><a href="javascript:;" path="role.html" tab-id="1-3">角色列表</a></dd>
                        <dd><a href="javascript:;" path="permission.html" tab-id="1-4">权限列表</a></dd>
                        <dd><a href="javascript:;" path="process.html" tab-id="1-5">流程列表</a></dd>
                        <dd><a href="javascript:;" path="login.html" tab-id="1-6">登陆页面</a></dd>
                        <dd><a href="javascript:;" path="404.html" tab-id="1-7">404页面</a></dd>
                        <dd><a href="javascript:;" path="403.html" tab-id="1-8">403页面</a></dd>
                        <dd><a href="javascript:;" path="500.html" tab-id="1-9">500页面</a></dd>
                        <dd><a href="javascript:;" path="donate.html" tab-id="1-10">捐赠列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" path="xxxx.html" tab-id="4-1">系统设置</a></dd>
                        <dd><a href="javascript:;" path="xxxx.html" tab-id="4-2">屏蔽词</a></dd>
                        <dd><a href="javascript:;" path="xxxx.html" tab-id="4-3">系统日志</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <i class="layui-icon">&#xe657;</i> 商品管理
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" path="toGoodsList" tab-id="5-1">商品</a></dd>
                        <dd><a href="javascript:;" path="xxxx.html" tab-id="5-2">商品类别</a></dd>
                        <dd><a href="javascript:;" path="xxxx.html" tab-id="5-3">供货商</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
