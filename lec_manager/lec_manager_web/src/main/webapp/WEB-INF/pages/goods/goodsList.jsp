...
<div class="ok-body">
    ...
    <div class="layui-row">
        <form class="layui-form layui-col-md12 ok-search">
            ...
            <input class="layui-input" placeholder="请输入商品名" autocomplete="off"  id="name">
    ...
    <okToolbar>
        ...
        <button class="layui-btn" id="addGoods">
    ...
    layui.use(['element', 'table', 'form', 'jquery', 'laydate'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                */
                {field: 'unit', title: '计量单位', width: 200},
                {field: 'inprice', title: '进价', width: 100},
                 {field: 'outprice', title: '出厂价', width: 100}, 
