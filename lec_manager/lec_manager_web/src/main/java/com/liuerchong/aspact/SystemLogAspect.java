...
//                   params += JsonUtil.getJsonStr(joinPoint.getArgs()[i]) + ";";  
                    ...
                    Class[] clazzs = method.getParameterTypes();  
                     if (clazzs.length == arguments.length) {  
                    	 if(method.isAnnotationPresent(ActionLog.class)){
                    		 actionGroup = method.getAnnotation(ActionLog.class).actionGroup();
                    		 actionType = method.getAnnotation(ActionLog.class).actionType();
                    		 actionDesc = method.getAnnotation(ActionLog.class).actionDesc();
                    		 insertDb = method.getAnnotation(ActionLog.class).insertDb();
                             break;  
                    	 }
                    }  
                }  
            ...
            System.out.println("方法描述:" + actionDesc);  
